                    ...
                    <div class="tab-pane fade show active" id="pages" Area-labelledby="pages-tab">
                        <div class="content-table">
                            <table id="colorTable" class="table p-table text-center">
                                <thead>
                                <tr>
                                    <th scope="col"><?php echo e(__('Area')); ?></th>
                                ...
                                <?php $__currentLoopData = $shipping_areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping_area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($shipping_area->name); ?></td>
                                        <td><?php echo e($shipping_area->charge); ?></td>
                                        <td><div class="form-switch"><input class="form-check-input status" type="checkbox" data-id="<?php echo e($shipping_area->id); ?>" <?php if($shipping_area->status): ?> checked <?php endif; ?>></div></td>
                                        <td>
                                            <ul>
                                                <li>
                                                    <a class="p-0 action" href="<?php echo e(route('backend.shipping_area.edit' , $shipping_area->id )); ?>">
                                                ...
                                                <li>
                                                    <form user="deleteForm" method="POST"
                                                          action="<?php echo e(route('backend.shipping_area.destroy',$shipping_area->id )); ?>">
                                                        <?php echo csrf_field(); ?>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#colorTable .status', function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "<?php echo e(route('shipping_area.status')); ?>",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/china_hub/resources/views/backend/pages/shipping_area/pages/index.blade.php ENDPATH**/ ?>