        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-5">
                <div class="top-bar-right">
                    <ul class="top-social">
                        <li>
                            <a href="<?php echo e(maanAppearance('facebook_link')); ?>" class="top-social-link facebook">
                                <i class="fa-brands fa-facebook-f"></i>
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo e(maanAppearance('youtube_link')); ?>" class="top-social-link youtube">
